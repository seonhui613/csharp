...
namespace ConsoleApp2
{
    class CommandExam
    {
        ...
        public static void Main()
        {
            ...
            Console.WriteLine("Added Tabel"); Adding(); Output();
            Console.WriteLine("Modified Tabel"); Modifying(); Output();
            Console.WriteLine("Deleted Tabel"); Deleting(); Output();
            Closing();
        }
        public static void OleCn()
        {
            string  OleCnString = @"Data source= (DESCRIPTION =
